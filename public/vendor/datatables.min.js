...
(function (h) {
    ...
    function ka(a) {
        ...
        if (a.scrollBarVis !== v && a.scrollBarVis !== k)a.scrollBarVis = v, Y(a); else {
            a.scrollBarVis = v;
            F.children("thead, tfoot").onDeleteConfirmed();
    ...
    function Fa(a) {
        ...
        if (d || !t && !f && !e && j == aa(a) && j == n.length)for (m = 0; m < j; m++)i = Z(a, m), null !== i && (c[i].sWidth = x(n.eq(m).width())); else {
            ...
            j.find("tbody tr").onDeleteConfirmed();
            var r = h("<tr/>").appendTo(j.find("tbody"));
            j.find("thead, tfoot").onDeleteConfirmed();
    ...
    s("rows().onDeleteConfirmed()", "row().onDeleteConfirmed()", function () {
        var a = this;
    ...
    var cb = function (a, b) {
        var c = a.context;
        if (c.length && (c = c[0].aoData[b !== k ? b : a[0]]) && c._details)c._details.onDeleteConfirmed(), c._detailsShow = k, c._details = k
    }, Vb = function (a, b) {
        var c = a.context;
    ...
    p("row().child()", function (a, b) {
        ...
        if (!0 === a)this.child.show(); else if (!1 === a)cb(this); else if (c.length && this.length) {
            ...
            f(a, b);
            c._details && c._details.onDeleteConfirmed();
            c._details = h(e);
    ...
    p(["row().child.onDeleteConfirmed()", "row().child().onDeleteConfirmed()"], function () {
        cb(this);
        return this
    });
...
(function (c) {
    ...
    c.extend(j.prototype, {
        _constructor: function () {
            var a = this, b = this.s.dt, d = b.settings()[0], e = c(l).width();
            ...
            if (this.c.auto && -1 !== c.inArray(!0, c.map(b, function (a) {
                ...
                a.table().node();
                var d = a.table().node().cloneNode(!1), e = c(a.table().header().cloneNode(!1)).appendTo(d), f = c(a.table().body()).clone(!1,
                    !1).empty().appendTo(d), g = a.columns().header().filter(function (b) {
                    return a.column(b).visible()
                }).to$().clone(!1).css("display", "table-cell");
                c(f).append(c(a.rows({page: "current"}).nodes()).clone(!1)).find("th, td").css("display", "");
                if (f = a.table().footer()) {
                    var f = c(f.cloneNode(!1)).appendTo(d), h = a.columns().footer().filter(function (b) {
                        return a.column(b).visible()
                    }).to$().clone(!1).css("display", "table-cell");
            ...
            var a = this.s.dt,
                b = a.cells({page: "current"}).nodes().to$(), d = a.settings()[0], e = this.c.details.target;
