 ...
 *   https://datatables.net/download/#bs/dt-1.10.12/af-2.1.2/cr-1.3.2/fh-3.1.2/r-2.1.0/sc-1.4.2/se-1.2.0
 *
 * Included libraries:
 *   DataTables 1.10.12, AutoFill 2.1.2, ColReorder 1.3.2, FixedHeader 3.1.2, Responsive 2.1.0, Scroller 1.4.2, Select 1.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="buscador form-control "'+classes.sFilterInput+'"/>';
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.12/af-2.1.2/cr-1.3.2/fh-3.1.2/r-2.1.0/sc-1.4.2/se-1.2.0",
...
// CONFIGURACION SELECT VER X POR PAGINA
		...
		return function ( api, rowIdx, columns ) {
			var data = $.map( columns, function ( col ) {
				return col.hidden ?
					...
					// Modificado para poner una celda con botones
					(col.title.length == 0 ? '<div class="btn-group" style="display:inline-block">' :
					'<span class="dtr-title">'+col.title+'</span><span class="dtr-data">'+col.data+'</span>')+
					(col.title.length == 0 ? col.data+'</div>' : '')+
					// Fin de modificacion
					'</li>' :
					'';
			} ).join('');
